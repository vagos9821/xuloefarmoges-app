          ...
          <div className="flex flex-col gap-10 lg:w-1/2 ">
            <div className="flex flex-col gap-5">
              ...
              <p>
                ...
                διστάσετε να επικοινωνήσετε μαζί μας. Η ομάδα μας είναι
                αφοσιωμένη στο να σας παρέχει κορυφαία εξυπηρέτηση και
                υπηρεσίες, καθώς είμαστε έτοιμοι να δουλέψουμε μαζί σας για να
                κάνουμε το όνειρο σας πραγματικότητα.
              </p>
            </div>
